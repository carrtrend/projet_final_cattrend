-- -------------------------------------------------------------------------------
-- Analyse mensuelle de la satisfaction client basée sur les notes des commandes
-- -------------------------------------------------------------------------------
-- Permet de calculer la note moyenne client par mois, en ne retenant que les 
