-- -------------------------------------------------------------------------------
-- Analyse de la satisfaction client selon le délai de réponse du support
-- -------------------------------------------------------------------------------
-- Permet de segmenter les avis clients en fonction du temps de réponse du support,
...
SELECT
  CASE
    WHEN temps_de_reponse IS NULL THEN 'inconnu'      -- Données manquantes ou non renseignées
